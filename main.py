...
def main():
    ...
    # Initial conditions
    ymax = 1.2#50.#1.5#100.         # for plotting purposes (animation)
    nx = 40                     # number of points in space
    xmax = 1.                   # physical domain parameters
    nt = 100#50#28#16 #50#100                     # number of time steps # needs to be 1 when output_substages is True for ImExRK scheme
    dt = 0.01                   # time step
    ...
    u_setting = 'constant'#'varying_space4'#'varying_space'       # 'constant' or 'varying_space' or 'varying_space_time' ---- # !!! 'constant' to 'uniform' and 'varying' to 'nonuniform'? # v!!! I am choosing on 21-04-2025 to keep the u_setting the same for all schemes, I could put it into the scheme parameters at a later point in time.  
    if u_setting == 'varying_space' or u_setting == 'varying_space_time' or u_setting == 'varying_space2' or u_setting == 'varying_space3' or u_setting == 'varying_space4' or u_setting == 'varying_space5':
        ...
        analytic = an.halfwave#revhalfwave      # initial condition, options: sine, cosbell, tophat, or combi # and more for varying velocity field
        uconstant = 1.#3.125#6.25#0.5#3.125#0.5         # constant velocity # should only apply when u_setting == 'constant' # is used in the analytic function and for the title in the final.pdf plot for the constant velocity field
    ...
    for xi in range(len(nx_arr)): # Loop over 1 or 3 grid spacings
        ...
        if u_setting == 'varying_space' or u_setting == 'varying_space2' or u_setting == 'varying_space3' or u_setting == 'varying_space4' or u_setting == 'varying_space5':
    ...
    if u_setting == 'constant':
        ...
        ut.design_figure(plotname, f'$\\Psi$ at t={nt*dt} with $u$ varying in space and time', \
                     'x', '$\\Psi$', 0., xmax, True, -0.1, 1.1)
    elif u_setting == 'varying_space2' or u_setting == 'varying_space3' or u_setting == 'varying_space4' or u_setting == 'varying_space5':
