...
def main():
    ...
    # Initial conditions
    ymin, ymax = 0., 1.5#200.#2. #8., 13.        # field min and max for plotting purposes (animation)
    nx = 40#400#128#40                     # number of points in space
    xmax = 1.#1000. #m #1.                   # physical domain parameters
    nt = 100 #32#16#2#32#100#10000#500#100 #50#100                      # number of time steps # needs to be 1 when output_substages is True for ImExRK scheme
    ...
    analytic = an.cosine_bell_x#an.combi#sine_xyshiftampl4#an.combi#double_square   # initial condition, options: sine, cosbell, tophat, or combi, halfwave, revhalfwave, and more for varying velocity field
    ...
    if u_setting == 'constant':
        uconstant = 1.#3.125#6.25#3.125#250.#50.#1.        # constant velocity # should only apply when u_setting == 'constant' # is used in the analytic function and for the title in the final.pdf plot for the constant velocity field
