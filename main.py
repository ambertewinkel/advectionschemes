...
def main():
    ...
    nt = 32#16#2#32#100#10000#500#100 #50#100                      # number of time steps # needs to be 1 when output_substages is True for ImExRK scheme
    ...
    analytic = an.combi#sine_xyshiftampl4#an.combi#double_square   # initial condition, options: sine, cosbell, tophat, or combi, halfwave, revhalfwave, and more for varying velocity field
    ...
    if u_setting == 'constant':
        uconstant = 3.125#6.25#3.125#250.#50.#1.        # constant velocity # should only apply when u_setting == 'constant' # is used in the analytic function and for the title in the final.pdf plot for the constant velocity field
