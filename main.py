...
def main():
    ...
    # Initial conditions
    ymin, ymax = 0., 2. #8., 13.        # field min and max for plotting purposes (animation)
    nx = 128#40                     # number of points in space
    xmax = 1000. #m #1.                   # physical domain parameters
    nt = 50#500#100 #50#100                      # number of time steps # needs to be 1 when output_substages is True for ImExRK scheme
    dt = 2.#0.2 #s #0.2#0.01                   # time step
    ...
    analytic = an.double_square   # initial condition, options: sine, cosbell, tophat, or combi, halfwave, revhalfwave, and more for varying velocity field
    u_setting = 'varying_time_space_swift_2Dnondiv'#_sin6'# 'constant' or various 'varying_space..' options
